...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case ComicNewsEntity:
			return comicNewsEntityFromJson(data as ComicNewsEntity, json) as T;			case HistoryEntity:
			return historyEntityFromJson(data as HistoryEntity, json) as T;			case IndexUpdateEntity:
			...
			return hotSearchEntityFromJson(data as HotSearchEntity, json) as T;			case FavoriteEntity:
			return favoriteEntityFromJson(data as FavoriteEntity, json) as T;			case ComicNewsHeaderEntity:
			return comicNewsHeaderEntityFromJson(data as ComicNewsHeaderEntity, json) as T;			case ComicNewsHeaderData:
			return comicNewsHeaderDataFromJson(data as ComicNewsHeaderData, json) as T;			case SearchResultEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case ComicNewsEntity:
			return comicNewsEntityToJson(data as ComicNewsEntity);			case HistoryEntity:
			return historyEntityToJson(data as HistoryEntity);			case IndexUpdateEntity:
			...
			return hotSearchEntityToJson(data as HotSearchEntity);			case FavoriteEntity:
			return favoriteEntityToJson(data as FavoriteEntity);			case ComicNewsHeaderEntity:
			return comicNewsHeaderEntityToJson(data as ComicNewsHeaderEntity);			case ComicNewsHeaderData:
			return comicNewsHeaderDataToJson(data as ComicNewsHeaderData);			case SearchResultEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'ComicNewsEntity':
			return ComicNewsEntity().fromJson(json);			case 'HistoryEntity':
			return HistoryEntity().fromJson(json);			case 'IndexUpdateEntity':
			...
			return HotSearchEntity().fromJson(json);			case 'FavoriteEntity':
			return FavoriteEntity().fromJson(json);			case 'ComicNewsHeaderEntity':
			return ComicNewsHeaderEntity().fromJson(json);			case 'ComicNewsHeaderData':
			return ComicNewsHeaderData().fromJson(json);			case 'SearchResultEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'ComicNewsEntity':
			return List<ComicNewsEntity>();			case 'HistoryEntity':
			return List<HistoryEntity>();			case 'IndexUpdateEntity':
			...
			return List<HotSearchEntity>();			case 'FavoriteEntity':
			return List<FavoriteEntity>();			case 'ComicNewsHeaderEntity':
			return List<ComicNewsHeaderEntity>();			case 'ComicNewsHeaderData':
			return List<ComicNewsHeaderData>();			case 'SearchResultEntity':
