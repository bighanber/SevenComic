...
import 'package:sevencomic/generated/json/history_entity_helper.dart';
...
import 'package:sevencomic/generated/json/comic_news_header_entity_helper.dart';
import 'package:sevencomic/entity/chapter_detail_entity.dart';
import 'package:sevencomic/generated/json/chapter_detail_entity_helper.dart';
...
import 'package:sevencomic/generated/json/comic_news_entity_helper.dart';
...
import 'package:sevencomic/generated/json/favorite_entity_helper.dart';
...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case IndexRankEntity:
			return indexRankEntityFromJson(data as IndexRankEntity, json) as T;			case IndexUpdateEntity:
			return indexUpdateEntityFromJson(data as IndexUpdateEntity, json) as T;			case HistoryEntity:
			return historyEntityFromJson(data as HistoryEntity, json) as T;			case HotSearchEntity:
			return hotSearchEntityFromJson(data as HotSearchEntity, json) as T;			case ComicNewsHeaderEntity:
			return comicNewsHeaderEntityFromJson(data as ComicNewsHeaderEntity, json) as T;			case ComicNewsHeaderData:
			return comicNewsHeaderDataFromJson(data as ComicNewsHeaderData, json) as T;			case ChapterDetailEntity:
			return chapterDetailEntityFromJson(data as ChapterDetailEntity, json) as T;			case ComicDetailEntity:
			...
			return comicDetailDhUrlLinkFromJson(data as ComicDetailDhUrlLink, json) as T;			case ComicNewsEntity:
			return comicNewsEntityFromJson(data as ComicNewsEntity, json) as T;			case IndexEntity:
			return indexEntityFromJson(data as IndexEntity, json) as T;			case IndexData:
			return indexDataFromJson(data as IndexData, json) as T;			case FavoriteEntity:
			return favoriteEntityFromJson(data as FavoriteEntity, json) as T;			case SearchResultEntity:
			return searchResultEntityFromJson(data as SearchResultEntity, json) as T;    }
    return data as T;
  }

  static _getToJson<T>(Type type, data) {
		switch (type) {			case IndexRankEntity:
			return indexRankEntityToJson(data as IndexRankEntity);			case IndexUpdateEntity:
			return indexUpdateEntityToJson(data as IndexUpdateEntity);			case HistoryEntity:
			return historyEntityToJson(data as HistoryEntity);			case HotSearchEntity:
			return hotSearchEntityToJson(data as HotSearchEntity);			case ComicNewsHeaderEntity:
			return comicNewsHeaderEntityToJson(data as ComicNewsHeaderEntity);			case ComicNewsHeaderData:
			return comicNewsHeaderDataToJson(data as ComicNewsHeaderData);			case ChapterDetailEntity:
			return chapterDetailEntityToJson(data as ChapterDetailEntity);			case ComicDetailEntity:
			...
			return comicDetailDhUrlLinkToJson(data as ComicDetailDhUrlLink);			case ComicNewsEntity:
			return comicNewsEntityToJson(data as ComicNewsEntity);			case IndexEntity:
			return indexEntityToJson(data as IndexEntity);			case IndexData:
			return indexDataToJson(data as IndexData);			case FavoriteEntity:
			return favoriteEntityToJson(data as FavoriteEntity);			case SearchResultEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'IndexRankEntity':
			return IndexRankEntity().fromJson(json);			case 'IndexUpdateEntity':
			return IndexUpdateEntity().fromJson(json);			case 'HistoryEntity':
			return HistoryEntity().fromJson(json);			case 'HotSearchEntity':
			return HotSearchEntity().fromJson(json);			case 'ComicNewsHeaderEntity':
			return ComicNewsHeaderEntity().fromJson(json);			case 'ComicNewsHeaderData':
			return ComicNewsHeaderData().fromJson(json);			case 'ChapterDetailEntity':
			return ChapterDetailEntity().fromJson(json);			case 'ComicDetailEntity':
			...
			return ComicDetailDhUrlLink().fromJson(json);			case 'ComicNewsEntity':
			return ComicNewsEntity().fromJson(json);			case 'IndexEntity':
			return IndexEntity().fromJson(json);			case 'IndexData':
			return IndexData().fromJson(json);			case 'FavoriteEntity':
			return FavoriteEntity().fromJson(json);			case 'SearchResultEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'IndexRankEntity':
			return List<IndexRankEntity>();			case 'IndexUpdateEntity':
			return List<IndexUpdateEntity>();			case 'HistoryEntity':
			return List<HistoryEntity>();			case 'HotSearchEntity':
			return List<HotSearchEntity>();			case 'ComicNewsHeaderEntity':
			return List<ComicNewsHeaderEntity>();			case 'ComicNewsHeaderData':
			return List<ComicNewsHeaderData>();			case 'ChapterDetailEntity':
			return List<ChapterDetailEntity>();			case 'ComicDetailEntity':
			...
			return List<ComicDetailDhUrlLink>();			case 'ComicNewsEntity':
			return List<ComicNewsEntity>();			case 'IndexEntity':
			return List<IndexEntity>();			case 'IndexData':
			return List<IndexData>();			case 'FavoriteEntity':
			return List<FavoriteEntity>();			case 'SearchResultEntity':
